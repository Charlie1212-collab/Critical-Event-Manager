        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            <div className="flex flex-col">
              ...
              <div className="text-sm">+9 silice yesbarday</div>
            </div>
          </Card>
          ...
          <Card>
            <div className="flex flex-col">
              ...
              <div className="text-sm">+1 silice yesbarday</div>
            </div>
          </Card>
          ...
          <Card>
            <div className="flex flex-col">
              ...
              <div className="text-3xl font-bold text-dark-text-white">7A</div>
              <div className="text-sm">+1 sinice ylesday</div>
            </div>
          </Card>
        </div>
      </section>
          ...
          <ul>
            <li className="flex items-center justify-between py-2 border-b border-dark-border">
              <div>
                ...
                <p className="text-sm">Wilban Nerace M sesday</p>
              </div>
              <div>
                <p className="text-sm">Florida</p>
                <p className="text-sm">Aloderna</p>
            ...
            <li className="flex items-center justify-between py-2 border-b border-dark-border">
              <div>
                ...
                <p className="text-sm">Warning Ese Offcern</p>
              </div>
              <div>
                <p className="text-sm">Alabema</p>
                <p className="text-sm">Sort: Starter</p>
            ...
            <li className="flex items-center justify-between py-2">
              <div>
                ...
                <p className="text-sm">Be Pespared</p>
              </div>
              <div>
          ...
          <ul>
            ...
            <li className="flex items-center justify-between py-2 border-b border-dark-border">
              <div>
                ...
                <p className="text-sm">Las Angeles, CA</p>
              </div>
              <div>
                <p className="text-sm">2 h ago</p>
              </div>
